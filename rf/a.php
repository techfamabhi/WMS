...
<div class="w3-main" style="margin-left:8px;margin-top:2px;">
    ...
    <div class="w3-half w3-row-padding w3-medium" style="padding-right:12px">
        <header class="w3-container w3-blue" style="padding-top:2px">
            <h3><b>Bin Check&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <button class="btn btn-primary btn-xs" name="srClr" id="srClr" onclick="do_binl()"
                            title="Lookup Parts by Bin">Lookup by Part
                    </button>
                </b>
                <div style='float:right;'>
                    <div style='position: fixed; top:20px;'>
                        <a class="menuI" title="Menu" href="/wms/webmenu.php"><img border="0"
                                                                                   src="/wms/images/menu_grey.png"></a>

                    </div>
                </div>
            </h3>
            <span id="sw">    <div class="w3-half">
      <div style="margin-left:0px;" class="w3-container"><span
                  style="font-weight: bold; font-size: large; text-align: center;">Invalid Bin</span></div>
    </div></span>
        </header>
    </div>
</div>
    ...
    <div class="w3-row-padding w3-margin-bottom">
        <div class="w3-half">
            <div class="w3-container myRed w3-padding-8">
                ...
                <input type="text" class="w3-white" onchange="do_bin();" value="" name="scaninput"
                       placeholder="Scan or enter Part" id="partnum" title="Scan or Enter Bin Number">
                <br>
                <br>
            </div>
        </div>
