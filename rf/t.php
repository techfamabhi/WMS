    ...
    <div class="table-responsive">
        <form name="form1" action="pack.php" method="get">
            ...
            <table class="w3-half table table-bordered table-striped">
                    ...
                    <td>
                        <table class="table table-bordered table-striped">
                            ...
                            <tr>
                                <td>116</td>
                                <td>
                                    <button name="verify[116]" onclick="document.form1.submit();"
                                            class="btn btn-info btn-xs">Verify
                                    </button>
                                </td>
                ...
                <tr>
                    <td colspan="4">
                        <button class="binbutton-small" id="B1" name="B1" onclick="document.form1.submit();">Pack It
                        </button>
