...
<title><strong>A-02-01-C</strong>
    &nbsp;
    <button class="btn btn-primary btn-xs" name="srClr" id="srClr" onclick="clearSearch()" title="Bin Check another
    Bin">Clear</button></title>
    ...
    <div class="w3-half w3-row-padding w3-medium" style="padding-right:12px">
        <header class="w3-container w3-blue" style="padding-top:2px">
            <h3><b><strong>A-02-01-C</strong>
                    &nbsp;
                    <button class="btn btn-primary btn-xs" name="srClr" id="srClr" onclick="clearSearch()"
                            title="Bin Check another Bin">Clear
                    </button>
                </b>
