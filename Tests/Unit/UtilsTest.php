...
use Linq\Utils as U, Linq\Functions as F;
use Linq\Tests\Stubs\Temp, Linq\Tests\Testing\TestCaseEnumerable;

class UtilsTest extends TestCaseEnumerable
{
    /** @covers \Linq\Utils::init
     */
    function testInit()
    {
        U::init();
    ...
    /** @covers \Linq\Utils::createLambda
     */
    ...
    function testCreateLambda_callableArray()
    {
        ...
        $f = U::createLambda([ 'Linq\Tests\Stubs\Temp', 'bar' ], 'a');
    ...
    /** @covers \Linq\Utils::createLambda
     * @covers \Linq\Utils::createLambdaFromString
     */
    ...
    /** @covers \Linq\Utils::createComparer
     */
    ...
    /** @covers \Linq\Utils::lambdaToSortFlagsAndOrder
     */
