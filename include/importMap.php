<?php
// importMap.php -- Import field Map to include when needed
//05/03/23 dse initial
...
// Customers
    ...
    "ORD" => array(  // Sales Order Header
        0 => "order_type", // O=Order, T=Transfer, D=Vendor Return
...
//num_lines, // auto increment
    ...
    "ITM" => array(  // Sales Order Items
        ...
        14 => "part_group",
        15 => "part_class",
        16 => "specord_num" // Incoming Document if line is a Special Order
//shadow, // lookup
//qty_ship, // 0
//qty_bo, // 0
//qty_avail, // lookup
