...
$data = getData($conn, "select * from PARTS,PARTHIST where paud_shadow = shadow_number ");

$grid_data = json_encode($data);
            ...
            <!-- Main row -->
                <section class="connectedSortable row">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Put Away Details</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
...
$('#gaugeChartPutAway').dxCircularGauge({
    ...
    $('#gridContainer').dxDataGrid({
        ...
        keyExpr: 'shadow_number',
        columns:  
        ['shadow_number','p_l','part_number','part_desc','part_class','paud_id','paud_date','paud_source','paud_user','paud_ref','paud_ext_ref','paud_type','paud_qty','paud_uom','paud_floc','paud_tloc','paud_prev_qty','paud_inv_code','paud_qty_core','paud_qty_def',],
        showBorders: true,
        columnWidth: 100,
        scrolling: {
