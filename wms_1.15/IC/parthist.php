...
$pg=new Bluejay;
$pg->title=$title;
$pg->Body="body onload=\"document.getElementById('paudType').focus();\"";
$pg->js=$js;
$pg->Display();
    ...
    <div class="panel-heading">
     <div class="row">
      <div class="col-md-6">
       <table>
        <tr>
         <th class="FieldCaptionTD" valign="bottom">Transaction Type</th>
         <th class="FieldCaptionTD" valign="bottom">Cust/Vendor/Oper</th>
         <th class="FieldCaptionTD" valign="bottom">P/L</th>
        </tr>
        <tr>
         <td valign="bottom">
           <select id="paudType" class="form-control" @change="changepaudType(\$event)">
            <option value="%">All</option>
            <option value="PCK">Pick</option>
            <option value="RCV">Receiving</option>
            <option value="PUT">Putaway</option>
         ...
         <td valign="top">
       <input id="custVend" type="text" style="width: 8em" class="form-control" v-model="custnum" @change="loadPL();"/>
         </td>
         <td valign="top">
       <input id="PLentry" type="text" size="6" style="width: 8em" class="form-control" v-model="PL" @change="loadPL();"/>
         </td>
        </tr>
       </table>
      </div>
...
var application = new Vue({
 ...
 //alert(application.rowFrom + ' ' + application.rowThru);
   ...
   else document.getElementById('paudType').focus();
  },
  initVars(flg) {
