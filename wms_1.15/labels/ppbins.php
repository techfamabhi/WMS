...
<div style="margin-right:100px">
 ...
 <input type="hidden" name="nextprog" value="pr_binbc.php"> 
 <table class="FormTABLE" cellspacing="2" cellpadding="2">
 <tr>
 <td colspan="2"><h3 class="FormHeaderFont" align="center">{$title}</h3></td>
 </tr>
 <tr>
  <td align="right" class="FieldCaptionTD"><label for="binFrom">Bin Range - From:</label></td>
