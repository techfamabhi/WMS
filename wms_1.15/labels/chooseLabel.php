...
$thisprogram="chooseLabel.php";
require_once("{$wmsInclude}/chklogin.php");
require_once("{$wmsInclude}/cl_Bluejay.php");
$title="Print Labels";

if (!isset($nextprog)) $nextprog="labeltest.php";
$sep="?";
foreach ($_REQUEST as $key=>$val)
{
 if ($key <> "nextprog") 
 {
  $nextprog.="{$sep}{$key}={$val}";
  $sep="&";
 }
...
<table>
 ...
 <tr>
  <td><a href="{$nextprog}{$sep}lbl=5160"><img src="{$wmsImages}/labels/avery_5160.png" border="0"></a></td>
  <td><a href="{$nextprog}{$sep}lbl=5161"><img src="{$wmsImages}/labels/avery_5161.png" border="0"></a></td>
  <td><a href="{$nextprog}{$sep}lbl=5162"><img src="{$wmsImages}/labels/avery_5162.png" border="0"></a></td>
 </tr>
 <tr>
  <td><a href="{$nextprog}{$sep}lbl=5163"><img src="{$wmsImages}/labels/avery_5163.png" border="0"></a></td>
  <td><a href="{$nextprog}{$sep}lbl=5164"><img src="{$wmsImages}/labels/avery_5164.png" border="0"></a></td>
  <td><a href="{$nextprog}{$sep}lbl=5167"><img src="{$wmsImages}/labels/avery_5167.png" border="0"></a></td>
 </tr>
</table>
</form>
</body>
