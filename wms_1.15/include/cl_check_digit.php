...
{
 private $formats;
 public $inputVal;       // the last input value used
 public $outputVal;      // the last output value 
 public $stdUsed;        // the last standard used;
 public $checkDigit;     // the last check digit calculated
 public $errCode;        // the last check digit calculated
 public $errText;        // the last Error Text
...
//Odd numbers x 3, even number x 1
 ...
 public function calc($val) {
  ...
  if (isset($this->formats[$this->stdUsed]) and is_numeric($val))
