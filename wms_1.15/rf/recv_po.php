...
if (isset($_REQUEST["scaninput"]) and $_REQUEST["scaninput"]=="complete")
{ // flag recpt done
...
//print_r($_REQUEST);
//exit;
   if (isset($_REQUEST["func"]) and $_REQUEST["func"]=="scanBin")
...
if (isset($func) and $func == "notOnPO")
{
 ...
 // Add part to PO here
  ...
  $ret=restSrv($TOTESRV,$req);
  $rdata=(json_decode($ret,true));
  if (isset($rdata["insertItem"]) and $rdata["insertItem"] > 0)
  { // line has been added
   $htm=<<<HTML
<!DOCTYPE html>
<html lang="en">
...
if ($func=="addedPO")
{
 ...
 { // got at least 1 po#
  ...
  { // valid host po#
   ...
   $i=1;
   if (isset($_REQUEST["poNum"]) and count($_REQUEST["poNum"]) > 0)
    { // more than 1 po
...
//exit;
  ...
  if (1 == 2 and isset($prefZone) and $ttzone <> "")
