    ...
    if (isset($result["infoType"]))
     {
      ...
      { // itsa part
       ...
       { // record to store
        ...
        if (isset($result["whseLoc"][$comp]) and count($result["whseLoc"][$comp]) > 0)
        { // whseloc isset
...
function recordError($db,$ctrlNum,$typ,$theBin,$theBin,$partNumber,$pl,$pn,$qty)
{
$SQL=<<<SQL
