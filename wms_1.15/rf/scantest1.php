        ...
        <table style="position:relative;left: 6px;" class="table table-bordered table-striped">
         ...
         <tr>
          <td colspan="5">
           ...
           <input type="submit" class="binbutton-small" id="b1" name="B1" value="Submit" onclick="document.form1.submit();">

           <button type="button" class="binbutton-small" id="b3" name="B3" value="ViewTote" onclick="doView(152); return false;">View</button>

           <button type="button" class="binbutton-small" id="b2" name="B2" value="done" onclick="do_done();">Done</button>
