 ...
 if ($numRows > 0)
 {
  ...
  $req=array(
   ...
   if ((isset($w1["RcptUpd"]) and $w1["RcptUpd"] > 0)
    or (isset($w1["ToteUpd"]) and $w1["ToteUpd"] > 0))
   { // all good
    $color="blue";
...
<input type="radio" name="adjType" value="R" {$ts["R"]} onchange="do_hd1('R',{$binQty});"><strong>Replace</strong>
          </td>
          <td nowrap class="w3-white" colspan="2" align="left" width="5%">
<input type="radio" name="adjType" value="A" {$ts["A"]} onchange="do_hd1('A',{$binQty});"><strong>Adjust</strong>
          </td>
         </tr>
         <tr>
