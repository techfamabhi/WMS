<?php
// noUPC1.php - report of parts with no UPC's
// 04/18/24 dse initial
...
$report->title = "Parts reported with no UPC";
...
$report->fields["Problem"] = "L,";
$report->fields["Name"] = "L,";
$report->fields["Ref"] = "L,";
$report->fields["Bin"] = "{$ba},";
$report->fields["Qty"] = "R,";
$report->fields["Occurred"] = "L,";
$report->fields["Stat"] = "R,";
...
item_status as Stat
from NOUPC,PARTS, WEB_USERS, WHSEQTY
{$where}
