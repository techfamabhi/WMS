...
//01/17/24 dse remove class from display, looked like it was qty avail
//TODO
        ...
        <div class="modal-content">
         ...
         <div class="modal-body">
          <div class="form-group">
           ...
           <input disabled type="text" title="The P/L Code" class="form-control" v-model="p_l"/>
          </div>
          <div class="form-group">
           <label title="">Part Number</label><span class="required">&nbsp;*</span>
           <input disabled type="text" title="The Part Number" class="form-control" v-model="part_number"/>
          </div>
          <div class="form-group">
