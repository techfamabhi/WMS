...
if (isset($_REQUEST["criteria"])) $criteria = $_REQUEST["criteria"]; else $criteria = array();
...
//Set up Sort
$report->SORT = $SORT;
$report->sort[0]["SQL"] ="order by pack_id,po_number,po_line_num,batch_num";

$report->sort[1]["SQL"] ="order by primary_bin,pack_id,po_number,po_line_num,batch_num";
