...
require_once("{$wmsDir}/../{$wmsServer}/cl_ORDERS.php");
$db = new WMS_DB;
/*
TODO
...
// if I have something to print return the output else return ""
    if ($print_it > 0) {
        return $pdf->Output("", "S");
    } else return "";
...
function check_oem($db, $det, $pl_comp)
{
    ...
    if ($oem_flag == 'Y') {   // prodline has OEM numbers
